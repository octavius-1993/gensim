...
#
# Edited July 2015 by Adam Foster to incorporate multiple subcorpora
...
class LdaModel(interfaces.TransformationABC):
    ...
    def __init__(self, corpus=None, num_topics=100, id2word=None,
        ...
        # No more support for auto alpha
    ...
    def inference(self, chunk, alpha, collect_sstats=False):
        """
        ...
        The alpha input should be an Alpha instance providing alpha parameters
        for every element of the chunk
        ...
        for d, doc in enumerate(chunk):
            ...
            for _ in xrange(self.iterations):
                ...
                gammad = alpha[d] + expElogthetad * numpy.dot(cts / phinorm, expElogbetad.T)
    ...
    def do_estep(self, chunk, alpha, state=None):
        """
        ...
        if state is None:
            state = self.state
        gamma, sstats = self.inference(chunk, alpha, collect_sstats=True)
        state.sstats += sstats
